...
//               <p><strong>ID:</strong> {tenants.indexOf(viewTenant) + 1}</p>              <p><strong>Building Name:</strong> {viewTenant.tenant_name}</p>
//               <p><strong>Manager Email:</strong> {viewTenant.tenant_email}</p>
//               <p><strong>Aadhaar No:</strong> {viewTenant.tenant_aadhar_number}</p>
//               <p><strong>Joining Date :</strong> {formatDate(viewTenant.joining_date)}</p>
