...
// const API_DATA = [
//   { name: 'Total Rooms', url: 'https://iiiqbets.com/pg-management/total-rooms-GET-API.php', route: '/rooms' },
//   { name: 'Total Beds', url: 'https://iiiqbets.com/pg-management/total-no-of-beds-GET-API.php', route: '/beds' },
//   { name: 'Available Beds', url: 'https://iiiqbets.com/pg-management/GET-Tenant-API-total-AVAILABLE-Beds.php', route: '/available-beds' },
//   { name: 'Total Income', url: 'https://iiiqbets.com/pg-management/total-income-mulitple-buildings-GET-API.php', route: '/incomedetails' },
//   { name: 'Total Expenditure', url: 'https://iiiqbets.com/pg-management/total-expenditure-manager-mail-buidling-GET-API.php', route: '/expenditure' },
//   { name: 'Total Complaints', url: 'https://iiiqbets.com/pg-management/total-no-of-complaints.php', route: '/complaints' },
// ];
